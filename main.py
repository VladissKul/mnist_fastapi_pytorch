...
# req json название проекта

# сиивол мешени, название кернела, на первом юпитере

# найти докер

# в репозиторий проект, в личную папку, не кернел

# при запуске контейнера давать имена

# тестирование, отправляет картинку, ожидает вывод, pytest
